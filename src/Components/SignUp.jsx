                            ...
                            <div class="card-body ">
                                ...
                                <div className="row g-3">
                                    ...
                                    <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                        <label htmlFor="" className="form-label">Class ID</label>
                                        <textarea name="classid" id="" className="form-control" value={input.classid} onChange={handleInput}    ></textarea>
                                    </div>
                                    ...
                                    <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                        <label htmlFor="" className="form-label">Class Name</label>
                                        <input type="text" className="form-control" name="classname" value={input.classname} onChange={handleInput} />
                                    </div>
                                    <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                    ...
                                    <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                        ...
                                        <input type="file" name="id" id="" className="form-control" onChange={handleInput} />
                                    </div>
                                    <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
